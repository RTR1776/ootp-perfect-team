      ...
      patch(
        ...
        ok
          ? {
              ...
              stats: json.stats as Record<string, unknown>,
              detail: json.alreadyImported ? `This exact file was already imported as upload #${json.uploadId}; nothing was written again.` : undefined,
            }
          : {
              status: "error",
              ...
              <CardHeader className="flex-row items-start justify-between gap-4 space-y-0">
                <div className="min-w-0">
                  ...
                  <CardDescription>
                    ...
                    {item.status === "done" && (item.detail ? ` · already on file (upload #${item.uploadId})` : ` · written (upload #${item.uploadId})`)}
                  </CardDescription>
                </div>
                <Button
                  variant="ghost"
